...
export const DurationSelector = ({ onSelect, disabled }: { onSelect: (duration: string) => void; disabled: boolean }) => {
    ...
    <div className="flex flex-col gap-3 mt-3 w-full sm:w-[80%] lg:w-[250px]">
      <div className="flex items-center justify-between border border-gray-200 rounded-xl p-2 bg-slate-50">
        ...
        <div className="flex flex-col items-center">
            ...
            <span className="text-[10px] text-gray-500 font-medium uppercase tracking-wider">{days === 1 ? 'Day' : 'Days'}</span>
        </div>
        <Button 
          variant="outline" 
          size="icon" 
