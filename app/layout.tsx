...
export const metadata: Metadata = {
  ...
  description: "Your personal AI travel expert. Get tailored itineraries, curated hotel options, and activities mapped on an interactive 3D globe in seconds.",
  keywords: [
    "ai trip planner",
    "travel planner",
    "itinerary generator",
  ...
  openGraph: {
    ...
    description: "Get personalized itineraries, curated hotel options, and activities mapped on a 3D globe using next-gen AI.",
