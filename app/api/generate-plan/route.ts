...
After collecting all information, DO NOT generate the final trip plan or itinerary. Instead, simply say "I have all the information needed! I am generating your trip plan now..." and return the "final" UI state.
The actual trip plan will be generated by a different API, so your only job is to collect the information and transition to the "final" state.
